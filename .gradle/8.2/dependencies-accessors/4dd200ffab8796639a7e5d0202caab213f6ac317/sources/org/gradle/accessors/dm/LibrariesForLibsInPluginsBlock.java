...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
     ...
     */
    @Deprecated
    public static class PlacesLibraryAccessors extends SubDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final PlacesVersionAccessors vaccForPlacesVersionAccessors = new PlacesVersionAccessors(providers, config);
        ...
        /**
         * Returns the group of versions at versions.places
         */
        public PlacesVersionAccessors getPlaces() {
            return vaccForPlacesVersionAccessors;
        }
    ...
    public static class PlacesVersionAccessors extends VersionFactory  {

        public PlacesVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: places.sdk (3.6.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getSdk() { return getVersion("places.sdk"); }
